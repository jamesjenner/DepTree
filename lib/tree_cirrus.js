...
function showInfoToast(text, closeCallback) {
  ...
  infoToast.addEventListener('onlick', hideInfoToast);
  infoToast.closeCallback = closeCallback;
...
function hideInfoToast() {
  ...
  if(infoToast.closeCallback != null && infoToast.closeCallback != undefined) {
    infoToast.closeCallback();
  }
}
